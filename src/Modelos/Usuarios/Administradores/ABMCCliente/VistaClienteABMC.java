 ...
 * @author nicdu
 */
public class VistaClienteABMC extends ABMGn {
    DefaultTableModel modelo = new DefaultTableModel();
    private GestorClienteABMC gr;
    ...
    public GestorClienteABMC getGestorClienteABMC() {
        if (gr == null) {
           synchronized (GestorClienteABMC.class) {
                gr = new GestorClienteABMC();
                gr.setForm(this);
           }
        }
        return gr;
    ...
    public void traerDatos(int max){
        limpiarTabla(modelo);
        getGestorClienteABMC().listarDatos(modelo,txtBuscar.getText(),max);
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        try {
            getGestorClienteABMC().setForm(this);
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        try {
            getGestorClienteABMC().setForm(this);
            getGestorClienteABMC().cargarDatos((Cliente) modelo.getValueAt(tableDatos.getSelectedRow(), 0));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaClienteABMC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaClienteABMC().setVisible(true);
            }
        });
    }
